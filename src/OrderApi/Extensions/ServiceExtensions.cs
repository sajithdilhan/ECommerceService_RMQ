    ...
    public static async Task AddRabbitMqMassTransitAsync(this WebApplicationBuilder builder, IAmazonSecretsManager secretsManager)
    {
        ...
        try
        {
            ...
            builder.Services.AddMassTransit(x =>
            {
                ...
                {
                    cfg.Host(baseRabbitSettings.Host,
                             baseRabbitSettings.VirtualHost,
                             h =>
                             {
                    ...
                    cfg.ReceiveEndpoint("order-service.user-created", e => e.ConfigureConsumer<UserCreatedConsumer>(context));
                });
            });
